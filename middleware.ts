 ...
 * 
 * Verifica que el dispositivo tenga la cookie de autorización antes de permitir acceso.
 * Excepciones: /autenticar y rutas de API públicas.
 * 
 * La validación real contra la base de datos se hace en las rutas protegidas.
 */
